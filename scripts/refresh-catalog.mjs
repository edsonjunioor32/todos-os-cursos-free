...
const CATALOGS = [
  ...
  },
  {
    ...
    urls: ["https://university.rdstation.com/cursos"],
    hosts: ["university.rdstation.com"],
    match: /university\\.rdstation\\.com\\/cursos\\/[^?#]+/i,
    requiredAnchorText: /gr[aá]tis|gratuito|free/i,
    category: "Cursos gratuitos",
    cert: "check",
    description: "Curso gratuito da Universidade RD Station.",
    minimumRecords: 1,
    failOnIncomplete: false,
    maxPages: 20
  },
